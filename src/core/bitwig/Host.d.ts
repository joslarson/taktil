import MidiIn from './MidiIn.d';
import Application from './Application.d';
import SceneBank from './SceneBank.d';
import Project from './Project.d';
import Preferences from './Preferences.d';
import Mixer from './Mixer.d';
import Transport from './Transport.d';
import DocumentState from './DocumentState.d';
import NotificationSettings from './NotificationSettings.d';
import CursorDevice from './CursorDevice.d';
import TrackBank from './TrackBank.d';
import Arranger from './Arranger.d';
import Clip from './Clip.d';
import RemoteSocket from './RemoteSocket.d';
import Track from './Track.d';
import UserControlBank from './UserControlBank.d';
import CursorTrack from './CursorTrack.d';
import Groove from './Groove.d';
import MidiOut from './MidiOut.d';
