declare namespace api {
    ...
    class Browser {
        /**
         * Registers an observer that reports if a browsing document was started.
         *
        ...
        /**
         * Cancels the current browser document.
         *
         * @since Bitwig Studio 1.2
         */
        cancelBrowsing(): void;
        ...
        /**
         * Finished the browser document by loading the selected item.
         *
         * @since Bitwig Studio 1.2
         */
        ...
        /**
         * Activates the given search document. Please note that only one search document can be active at a time.
         *
         * @param {BrowsingSession} document the document that should be activated.
         * @throws ControlSurfaceException
         * @since Bitwig Studio 1.2
         */
        activateSession(document?: BrowsingSession): void;
        ...
        /**
         * Returns an object that provided bank-wise navigation of the available search documents.
         * Each search document is dedicated to a certain material type, as shown in the tabs of
         * Bitwig Studio's contextual browser.
         *
         * @param {int} size the size of the windows used to navigate the available browsing documents.
         ...
         *
         * @return {CursorBrowsingSession} the requested browsing document cursor
         * @since Bitwig Studio 1.2
         */
         ...
         *
         * @return {DeviceBrowsingSession} the requested controller browsing document instance
         * @since Bitwig Studio 1.2
         */
         ...
         * contextual browser window.
         *
         * @return {PresetBrowsingSession} the requested preset browsing document instance
         * @since Bitwig Studio 1.2
         */
         ...
         * contextual browser window.
         *
         * @return {SampleBrowsingSession} the requested sample browsing document instance
         * @since Bitwig Studio 1.2
         */
         ...
         * contextual browser window.
         *
         * @return {MultiSampleBrowsingSession} the requested multi-sample browsing document instance
         * @since Bitwig Studio 1.2
         */
         ...
         * contextual browser window.
         *
         * @return {ClipBrowsingSession} the requested clip browsing document instance
         * @since Bitwig Studio 1.2
         */
         ...
         * contextual browser window.
         *
         * @return {MusicBrowsingSession} the requested music browsing document instance
         * @since Bitwig Studio 1.2
         */
    ...
    /**
     * Instances of this interface are used to navigate the columns of a Bitwig Studio browser document.
     *
     * @since Bitwig Studio 1.2
     */
     ...
     * collection.
     *
     * In Bitwig Studio's contextual browser window the search documents for the various material kinds are shown
    ...
    class BrowsingSession {
        /**
         * Registers an observer that reports if the browser document is available for the current context.
         *
        ...
        /**
         * Registers an observer that reports if the browser document is currently active.
         *
         * @param {function} callback a callback function that receives a single boolean argument.
         * @since Bitwig Studio 1.2
         */
        ...
        /**
         * Activates the given search document, same as calling
         * {@link Browser#activateSession Browser#activateSession(this)}.
         * Please note that only one search document can be active at a time.
         *
         * @throws ControlSurfaceException
         * @since Bitwig Studio 1.2
         */
        ...
        /**
         * Returns an object that can be used to navigate over the various filter sections of the browsing document.
         *
    ...
    /**
     * Instances of this interface are used to navigate the available documents in Bitwig Studio's contextual browser.
     * The documents are shown as tabs in the graphical user interface of the browser.
     *
     * @since Bitwig Studio 1.2
     */
    class BrowsingSessionBank {
        /**
         * Returns the window size that was used to configure the document bank during creation.
         *
         * @return {int} the size of the document bank.
         * @since Bitwig Studio 1.2
         */
        getSize(): number;

        /**
         * Returns the browser document for the given index.
         *
         * @param {int} index the document index, must be in the range `[0..getSize-1]`
         * @return {GenericBrowsingSession} the requested browser document object
         * @since Bitwig Studio 1.2
         */
        getSession(index?: number): GenericBrowsingSession;

        /**
         * Scrolls the browser documents one item up.
         *
         * @since Bitwig Studio 1.2
         */
        scrollUp(): void;
        ...
        /**
         * Scrolls the browser documents one item down.
         *
         * @since Bitwig Studio 1.2
         */
        scrollDown(): void;
        ...
        /**
         * Scrolls the browser documents one page up.
         * For example if the bank is configured with a window size of 8 entries and is currently showing items
        ...
        /**
         * Registers an observer that reports the current scroll position, more specifically the position of the first
         * item within the underlying list of browser documents, that is shown as the first document within the window.
         *
         * @param {function} callback a callback function that receives a single integer number parameter. The parameter reflects
                        the scroll position, or `-1` in case the column has no content.
         * @since Bitwig Studio 1.2
        ...
        /**
         * Registers an observer that reports if the browser documents can be scrolled further up.
         *
         * @param {function} callback a callback function that receives a single boolean parameter
         * @since Bitwig Studio 1.2
         */
        ...
        /**
         * Registers an observer that reports if the browser documents can be scrolled further down.
         *
         * @param {function} callback a callback function that receives a single boolean parameter
         * @since Bitwig Studio 1.2
         */
        ...
        /**
         * Registers an observer that reports the underlying total count of browser documents
         * (not the size of the window).
         *
         * @param {function} callback a callback function that receives a single integer parameter
         * @since Bitwig Studio 1.2
    ...
    /**
     * Instances of this interface are used to navigate the filter columns of a Bitwig Studio browsing document.
     *
     * @since Bitwig Studio 1.2
     */
    ...
    /**
     * Instances of this interface are used for navigating the various browsing documents of
     * Bitwig Studio's contextual browser.
     *
     * @since Bitwig Studio 1.2
     */
    ...
    class CursorDevice extends Cursor {
         ...
         *
         * @param {Device} controller the controller that this cursor should point to
         * @since Bitwig Studio 1.1
         */
        selectDevice(controller?: Device): void;
    ...
    /**
     * Instances of this interface represent the cursor item in controller layer selections.
     *
     * @since Bitwig Studio 1.1
     */
    ...
    /**
     * Instances of this interface represent the selected controller slot as shown in the Bitwig Studio user interface.
     *
    ...
    class Device {
         ...
         *
         * @return {DeviceChain} the requested controller chain object
         * @since Bitwig Studio 1.1.6
         */
         ...
         * and navigate to controllers in those slots using the {@link CursorDevice} interface.
         *
         ...
         * @return {DeviceLayerBank} a controller layer bank object configured with the desired number of channels
         * @throws ControlSurfaceException
         * @since Bitwig Studio 1.1
         */
         ...
         * in case it has any.
         *
         * @return {CursorDeviceLayer} a cursor controller layer instance
         * @throws ControlSurfaceException
         * @since Bitwig Studio 1.1
         */
         ...
         *
         * @param {int} numDevices the number of controllers that are simultaneously accessible
         * @return {DeviceBank} the requested controller bank object
         * @throws ControlSurfaceException
         * @since Bitwig Studio 1.1.6
         */
    ...
    class DeviceBank {
         ...
         * @return {Device} the requested controller object
         * @since Bitwig Studio 1.1
         */
    ...
    class DeviceChain {
         ...
         *
         * @param {int} numDevices the number of controllers should be accessible simultaneously
         * @return {DeviceBank} the requested controller bank object
         * @throws ControlSurfaceException
         * @since Bitwig Studio 1.1
         */
    ...
    /**
     * Instances of this interface represent controller layers in Bitwig Studio.
     *
     * @since Bitwig Studio 1.1
     */
    ...
    /**
     * Devices layers are features of special Bitwig Studio controllers, more specifically the Layer Instrument and
     ...
     *
     * To receive an instance of controller layer bank call {@link Device#createLayerBank(int numChannels)}.
     *
    ...
    class DeviceLayerBank extends ChannelBank {
         ...
         * @return {DeviceLayer} the controller layer object
         * @since Bitwig Studio 1.1
         */
    ...
    /**
     * Instances of this interface represent nested FX slots in controllers.
     *
     * @since Bitwig Studio 1.1
     */
    ...
    class GenericBrowsingSession extends BrowsingSession {
        /**
         * Registers an observer that reports the name of the browsing document.
         *
         * @param {int} maxCharacters
         * @param {string} textWhenUnassigned
         * @param {function} callback
    ...
    class Host {
         ...
         *
         * @return {CursorDevice} an object representing the currently selected controller.
         * @throws ControlSurfaceException
         * @since Bitwig Studio 1.1
         */
    ...
    class PrimaryDevice extends Device {
         ...
         *
         * @param {PrimaryDevice.DeviceType} controllerType the requested controller type of the new primary controller
         * @param {PrimaryDevice.ChainLocation} chainLocation the requested chain location of the new primary controller
         * @since Bitwig Studio 1.0
         */
        switchToDevice(controllerType?: DeviceType, chainLocation?: ChainLocation): void;
         ...
         * @since Bitwig Studio 1.0
         */
        addCanSwitchToDeviceObserver(controllerType?: DeviceType, chainLocation?: ChainLocation, callback?: Function): void;
    ...
    class Track extends Channel {
         ...
         *
         * @return {CursorDevice} the requested controller selection cursor object
         * @throws ControlSurfaceException
         * @since Bitwig Studio 1.1
         */
